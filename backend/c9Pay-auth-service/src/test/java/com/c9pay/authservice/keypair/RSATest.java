...
public class RSATest {
    ...
    public static void main(String[] args) {
        ...
        String encryptedText = encode(plainText, privateKey);
        System.out.println("암호화: " + encryptedText);

        String decryptedText = decode(encryptedText, publicKey);
     ...
     * 암호화
     */
    static String encode(String plainData, String stringPrivateKey) {
     ...
     * 복호화
     */
    static String decode(String encryptedData, String stringPublicKey) {
